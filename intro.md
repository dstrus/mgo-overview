...
But seriously, folks, if that all sounds immersion-breaking and maybe even a bit tedious, let me tell you the Good News.

Say “hello” to Mad God’s Overhaul, a mod list for The Elder Scrolls V: Skyrim VR.

Have you installed Mad God’s Overhaul? Well, look at you! If you haven’t installed MGO, that’s OK too. I’ll give you the quick version of how to download and install the list, and if you run into trouble or need more detail, you’ll find links to more details in the description.

I’m mostly here to talk about what happens after you install the list. I’ll talk about what you can do with MGO, and how you do it. How to get started playing, how some of the game mechanics work, and how to tweak certain things to your liking.
...
MGO includes somewhere in the neighborhood of 2,000 mods. You don’t need to be familiar with all of them to enjoy yourself. But there are dozens of included mods that make pretty significant—and often surprising—changes to the way the game is played. They may overhaul entire gameplay systems, or they may dramatically expand your options for how to perform even the most basic actions in the game, like drawing your weapon, or looking at a map, or even walking.
